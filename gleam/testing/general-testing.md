...
BDD/Gherkin (`dream_test`) has its own cross-ecosystem write-up: see [BDD with Gherkin](../../practices/bdd-with-gherkin.md).
...
>
> **Covered in [BDD with Gherkin](../../practices/bdd-with-gherkin.md):**
...
#### dream_test
[repo](https://github.com/TrustBound/dream_test) · also see [BDD with Gherkin](../../practices/bdd-with-gherkin.md)
